...
#ifndef SYNTHESIS_TRANSFORM2_AWPROJECTFT_H
#define SYNTHESIS_TRANSFORM2_AWPROJECTFT_H
...
namespace casa { //# NAMESPACE CASA - BEGIN
  ...
  public:
    ...
    virtual void initializeToVis(casacore::ImageInterface<casacore::Complex>& image,
				 const vi::VisBuffer2& vb, casacore::Array<casacore::Complex>& griddedVis,
    ...
    // present in ms.
    void get(vi::VisBuffer2& vb, casacore::Cube<casacore::Complex>& degrid, 
	     casacore::Array<casacore::Complex>& griddedVis, casacore::Vector<casacore::Double>& scale, 
	     casacore::Int row=-1);
    
    void get(vi::VisBuffer2& vb, casacore::Cube<casacore::Float>& pointingOffsets, casacore::Int row=-1,
	     FTMachine::Type whichVBColumn=FTMachine::MODEL,casacore::Int Conj=0)
    {
      get(vb,vb,vb,pointingOffsets,row,whichVBColumn,whichVBColumn,Conj,0);
    }
    
    void get(vi::VisBuffer2& vb, vi::VisBuffer2& gradAzVB,vi::VisBuffer2& gradElVB,
    ...
    virtual casacore::Int findPointingOffsets(const vi::VisBuffer2&, casacore::Array<casacore::Float>&, casacore::Array<casacore::Float>&,
				    casacore::Bool Evaluate=true);
    virtual casacore::Int findPointingOffsets(const vi::VisBuffer2&, casacore::Cube<casacore::Float>&,
    ...
    casacore::MDirection::Convert makeCoordinateMachine(const vi::VisBuffer2&,
